 ...
 */
@Entity
@NamedQuery(name="Epidemevent.findAll", query="SELECT e FROM Epidemevent e")
public class Epidemevent implements Serializable {
	...
	//bi-directional many-to-one association to Nexuspoll
	@OneToMany(mappedBy="epidemevent")
	...
	//bi-directional many-to-one association to Vulnerabilitypoll
	@OneToMany(mappedBy="epidemevent")
