...
/**
 * The persistent class for the FEV_INSTITUTION database table.
 * 
 */
@Entity
...
public class FevInstitution implements Serializable {
	...
	@Id
	@SequenceGenerator(name="FEV_INSTITUTION_INSTID_GENERATOR", sequenceName="FEV_INSTITUTION_SEQ")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="FEV_INSTITUTION_INSTID_GENERATOR")
	@Column(name="INST_ID")
	private long instId;
