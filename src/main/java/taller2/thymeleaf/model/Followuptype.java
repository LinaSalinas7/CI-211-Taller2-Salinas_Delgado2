 ...
 */
@Entity
@NamedQuery(name="Followuptype.findAll", query="SELECT f FROM Followuptype f")
public class Followuptype implements Serializable {
	...
	//bi-directional many-to-one association to Followupinterested
	@OneToMany(mappedBy="followuptype")
	...
	//bi-directional many-to-one association to FolltypeEvestat
	@OneToMany(mappedBy="followuptype")
