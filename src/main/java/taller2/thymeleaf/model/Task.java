...
import Validations.Validation2;
...
public class Task implements Serializable {
	...
	@Column(name="TASK_ID")
	@NotNull(groups = {Validation1.class, Validation2.class})
	private long taskId;
	...
	//bi-directional many-to-one association to FetTaskinstance
	...
	//bi-directional many-to-one association to Timerconfig
	@OneToMany(mappedBy="task")
